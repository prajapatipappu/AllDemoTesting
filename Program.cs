...
namespace DemoToolTesting
{
    internal class Program
    {
        ...
        private static void Accordians()
        {
            /* IWebDriver Driver = new ChromeDriver();
             IJavaScriptExecutor js = (IJavaScriptExecutor)Driver;
             Thread.Sleep(2000);
        ...
        private static void Date_Picker()
        {
            /* IWebDriver Driver = new ChromeDriver();
              IJavaScriptExecutor js = (IJavaScriptExecutor)Driver;
              Thread.Sleep(2000);
        ...
        private static void Progress_Bar()
        {
            /* IWebDriver Driver = new ChromeDriver();
             IJavaScriptExecutor js = (IJavaScriptExecutor)Driver;
             Thread.Sleep(2000);
        ...
        private static void Selecttables()
        {
